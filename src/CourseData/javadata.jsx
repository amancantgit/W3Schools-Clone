...
const javaTutorials = [
  "Introduction", "Syntax", "Variables", "Data Types", "Type Casting", "Operators", "Arrays", "Methods", 
...
const Javadata = ({ darkMode }) => {
  return (
    <>
  <div style={{height: '97vh',display: 'flex', background: darkMode ? 'black' : 'white', color: darkMode ? 'white' : 'black' }}>
